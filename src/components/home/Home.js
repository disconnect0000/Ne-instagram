...
function Home() {
  ...
  }, [axios.get("https://ne-instagram.herokuapp.com/upload").then((res) => {})]);

  const username = localStorage.getItem("usernameMYwebsite");

  function handleDeletePost(postId) {
    axios
      .post("https://ne-instagram.herokuapp.com/delete", { postId: postId })
      .then((res) => {
        getPosts();
      });
  }
  ...
  const getPosts = () => {
    axios
      .get("https://ne-instagram.herokuapp.com/upload")
      .then((res) => {
